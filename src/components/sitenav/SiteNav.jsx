...
const logUserOut = e => {
  console.log("logging user out",e)
  props.userLogOut()
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarsExample04">
            ...
            <div className="text-end">
              ...
              {props.currentUser.isLoggedIn && <Link to="/login" 
              type="button" 
              className="btn btn-outline-light me-2"
              onClick={logUserOut}>
                Logout </Link>} 

                {!props.currentUser.isLoggedIn && <Link to="/login" type="button" className="btn btn-outline-light me-2">
                Log In </Link>} 
